...
class FetchInventarioUsecase {
  ...
  Future<List<InventoryEntity>> call(String description,String familia, String subfamilia,int page,int pageSize) async {
    return await inventoryRepository.fetchInventario(description, familia,  subfamilia,page,pageSize);
  }
}