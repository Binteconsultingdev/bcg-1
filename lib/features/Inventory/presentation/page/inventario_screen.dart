  ...
  return Container(
    ...
    child: Column(
      children: [
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: controller.searchByDescription.value
        ...
        // Toggle descripción / número de parte
        Obx(() => Row(
              children: [
                _toggleChip(
                  label: 'Descripción',
                  selected: controller.searchByDescription.value,
                  onTap: () => controller.searchByDescription.value = true,
                ),
                const SizedBox(width: ThemeColor.paddingSmall),
                _toggleChip(
                  label: 'Núm. Parte',
                  selected: !controller.searchByDescription.value,
                  onTap: () => controller.searchByDescription.value = false,
                ),
              ],
            )),
      ],
