...
class InventoryModel extends InventoryEntity {
  InventoryModel({required super.id, required super.partNumber, required super.description,  super.family,  super.subfamily,  super.availableQuantity,  super.price,  super.imageUrl});
